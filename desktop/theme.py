...
QComboBox, QAbstractSpinBox, QLineEdit { background:#0a2947; border:1px solid #33739b; border-radius:5px; color:#e5f4ff; min-height:28px; padding:4px 8px; }
QLineEdit::placeholder { color:#86abc5; }
