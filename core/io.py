...
def example_dataframe() -> pd.DataFrame:
    ...
    positions = (
        ...
        ((13, 11), (15, 13)), ((40, 40), (42, 42)), ((41, 41), (43, 43)),
        ((42, 40), (44, 42)), ((75, 75), (77, 77)), ((76, 76), (78, 78)),
        ((0, 0), (4, 2)), ((30, 5), (34, 7)), ((60, 5), (64, 7)),
        ((95, 5), (100, 7)), ((10, 90), (14, 94)), ((90, 95), (100, 100)),
    )
    frequencies = (1.5, 1.5, 1.5, 1.5, 4.5, 4.5, 4.5, 7.5, 7.5, 2.5, 3.5, 5.5, 6.5, 8.5, 9.0)
