...
def example_dataframe() -> pd.DataFrame:
    rows = []
    positions = (
        ((10, 12), (14, 16)), ((10, 13), (14, 15)),
        ((45, 55), (51, 61)), ((45, 56), (51, 59)),
        ((82, 15), (88, 21)), ((82, 16), (88, 19)),
        ((18, 18), (22, 22)), ((50, 62), (56, 68)), ((77, 20), (83, 26)),
        ((25, 78), (31, 84)), ((28, 75), (34, 81)),
        ((5, 45), (11, 51)), ((55, 90), (61, 96)),
        ((15, 92), (21, 98)), ((72, 45), (78, 51)),
    )
    frequencies = (2.0, 2.0, 5.5, 5.5, 7.5, 7.5, 2.0, 5.5, 7.5, 3.5, 3.53, 4.5, 6.0, 1.5, 9.0)
    bandwidths = (20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0, 20.0)
        ...
        rows.append(
            {
                ...
                "bandwidth_mhz": bandwidths[index],
                "tx_power_dbm": 30.0,
            }
        )
